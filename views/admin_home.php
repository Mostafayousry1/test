...
if ($_SESSION['username'] && $_SESSION['type'] == "admin") { ?>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            ...
            <a href="../views/admin_view_students.php" class="btn btn-outline-success my-2 my-sm-0" type="submit" name="submitLogout">View Students</a>
            <a href="studentcourse.php" class="btn btn-outline-success my-2 my-sm-0" type="submit"  >Courses</a>
            <a href="addcourse.php" class="btn btn-outline-success my-2 my-sm-0" type="submit"  >Add Courses</a>
            <a href="../views/admin_view_professor.php" class="btn btn-outline-success my-2 my-sm-0" type="submit" name="submitLogout">View professor</a>
